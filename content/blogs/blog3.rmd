...
```
>In order to perform analyses on on financial stocks, we have downloaded the following dataset.
...
>We now went on to plot a density plot for each of the stocks.
